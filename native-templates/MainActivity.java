...
public class MainActivity extends BridgeActivity {
    ...
    /* Captures an audio file handed to the app via "Open with" (ACTION_VIEW)
       or "Share to" (ACTION_SEND) from a file manager or another app, reads
       its bytes, and stashes them in IncomingAudioPlugin for the JS side to
       pick up and feed straight into the Add wizard. */
    private void handleIncomingIntent(Intent intent) {
        ...
        try {
            ...
            IncomingAudioPlugin.setPending(base64, filename, mimeType);
        } catch (Exception e) {
